...
public class MenuConfiguraciones extends JPanel {
    ...
    public MenuConfiguraciones addOyenteConfiguracion(SettingListener oyente) {
        this.listeners.add(oyente);
        return this;
    }
    
    private void fireOyentesConfiguracion(SettingListener.Opcion op) {
        for (final SettingListener oc : this.listeners) {
            if (oc != null) {
                oc.opcion(op);
            }
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        fireOyentesConfiguracion(SettingListener.Opcion.Usuario);
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        fireOyentesConfiguracion(SettingListener.Opcion.Aplicacion);
