...
-- Eliminar relaciones para poder borrar tablas_y crearlas de nuevo

ALTER TABLE Factura DROP FOREIGN KEY Relationship8;
ALTER TABLE DetalleVenta DROP FOREIGN KEY Relationship9;
ALTER TABLE DetalleVenta DROP FOREIGN KEY Relationship10;
ALTER TABLE Factura DROP FOREIGN KEY Relationship11;
ALTER TABLE Factura DROP FOREIGN KEY Relationship18;
ALTER TABLE Compra DROP FOREIGN KEY Relationship6;
ALTER TABLE Compra DROP FOREIGN KEY Relationship7;
ALTER TABLE Compra DROP FOREIGN KEY Relationship21;
ALTER TABLE Proveedor DROP FOREIGN KEY Relationship20;
ALTER TABLE Cliente DROP FOREIGN KEY Relationship19;
ALTER TABLE Producto DROP FOREIGN KEY Relationship2;
ALTER TABLE Stock DROP FOREIGN KEY Relationship3;
ALTER TABLE DetalleCompra DROP FOREIGN KEY Relationship4;
ALTER TABLE DetalleCompra DROP FOREIGN KEY Relationship5;
ALTER TABLE Usuario DROP FOREIGN KEY Relationship14;
ALTER TABLE Rol DROP FOREIGN KEY Relationship15;
ALTER TABLE Caja DROP FOREIGN KEY Relationship16;
