...
public class TipoPagoController {
    ...
    public List<TipoPagoModel> obtenerTipoPagoPorId(int idTipoPago) {
        return tipoPagoDao.obtenerTipoPagoPorId(idTipoPago);
    }
    // Obtener el nombre de un tipo de pago por su ID
    public String obtenerNombreTipoPagoPorId(int idTipoPago) {
        return tipoPagoDao.obtenerNombreTipoPagoPorId(idTipoPago);
    }
