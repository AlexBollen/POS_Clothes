...
import org.wass.models.product.TipoProducto.TipoProductoDAO;
...
public class TipoProductoController {
    ...
    // Obtener una lista de los nombres de los tipos de producto
    ...
    public List<TipoProductoModel> obtenerTipoProducto(int idTipoProducto) {
        return tipoProductoDao.obtenerTipoProductoPorId(idTipoProducto);
    }
    // Obtener el nombre de un tipo de producto por su ID
    public String obtenerNombreTipoProductoPorId(int idTipoProducto) {
        return tipoProductoDao.obtenerNombreTipoProductoPorId(idTipoProducto);
    }
    ...
    public boolean eliminarTipoProducto(int tipoproductoId) {
        ...
        if (resultado) {
            ...
            JOptionPane.showMessageDialog(null, "Error al eliminar el tipo deproducto", "Error", JOptionPane.ERROR_MESSAGE);
        }
        return resultado;
    }
}
